...
public class RecipesAether
{
	...
	private static void registerCoolerRecipes()
	{
		...
		CoolerRecipes.instance().addCoolingFromItem(ItemsAether.irradiated_charm, Item.getItemFromBlock(Blocks.AIR), new ItemStack(ItemsAether.irradiated_dust),
				MapGen.genMap(new ItemStack(ItemsAether.irradiated_dust), 30),
				//MapGen.genMap(new ItemStack(ItemsAether.charm_arm_01), 20),
				//MapGen.genMap(new ItemStack(ItemsAether.charm_arm_02), 5),
				//MapGen.genMap(new ItemStack(ItemsAether.charm_arm_tgh_01), 20),
				//MapGen.genMap(new ItemStack(ItemsAether.charm_arm_tgh_02), 5),
				//MapGen.genMap(new ItemStack(ItemsAether.charm_atk_spd_01), 20),
				//MapGen.genMap(new ItemStack(ItemsAether.charm_atk_spd_02), 5),
				//MapGen.genMap(new ItemStack(ItemsAether.charm_imp_dmg_01), 20),
				//MapGen.genMap(new ItemStack(ItemsAether.charm_imp_dmg_02), 5),
				//MapGen.genMap(new ItemStack(ItemsAether.charm_kbk_res_01), 20),
				//MapGen.genMap(new ItemStack(ItemsAether.charm_kbk_res_02), 5),
				//MapGen.genMap(new ItemStack(ItemsAether.charm_lck_01), 20),
				//MapGen.genMap(new ItemStack(ItemsAether.charm_lck_02), 5),
				MapGen.genMap(new ItemStack(ItemsAether.charm_max_hlt_01), 20),
				//MapGen.genMap(new ItemStack(ItemsAether.charm_max_hlt_02), 5),
				MapGen.genMap(new ItemStack(ItemsAether.charm_mve_spd_01), 20),
				MapGen.genMap(new ItemStack(ItemsAether.charm_mve_spd_02), 5),
				//MapGen.genMap(new ItemStack(ItemsAether.charm_prc_dmg_01), 20),
				//MapGen.genMap(new ItemStack(ItemsAether.charm_prc_dmg_02), 5),
				MapGen.genMap(new ItemStack(ItemsAether.charm_res_amb_01), 20),
				MapGen.genMap(new ItemStack(ItemsAether.charm_res_amb_02), 5),
				MapGen.genMap(new ItemStack(ItemsAether.charm_res_bld_01), 20),
				MapGen.genMap(new ItemStack(ItemsAether.charm_res_bld_02), 5),
				MapGen.genMap(new ItemStack(ItemsAether.charm_res_fra_01), 20),
				MapGen.genMap(new ItemStack(ItemsAether.charm_res_fra_02), 5),
				MapGen.genMap(new ItemStack(ItemsAether.charm_res_frz_01), 20),
				MapGen.genMap(new ItemStack(ItemsAether.charm_res_frz_02), 5),
				MapGen.genMap(new ItemStack(ItemsAether.charm_res_grd_brk_01), 20),
				MapGen.genMap(new ItemStack(ItemsAether.charm_res_grd_brk_02), 5),
				MapGen.genMap(new ItemStack(ItemsAether.charm_res_irr_01), 20),
				MapGen.genMap(new ItemStack(ItemsAether.charm_res_irr_02), 5),
				MapGen.genMap(new ItemStack(ItemsAether.charm_res_stn_01), 20),
				MapGen.genMap(new ItemStack(ItemsAether.charm_res_stn_02), 5),
				MapGen.genMap(new ItemStack(ItemsAether.charm_res_tox_01), 20),
				MapGen.genMap(new ItemStack(ItemsAether.charm_res_tox_02), 5),
				MapGen.genMap(new ItemStack(ItemsAether.charm_res_ven_01), 20),
				MapGen.genMap(new ItemStack(ItemsAether.charm_res_ven_02), 5),
				MapGen.genMap(new ItemStack(ItemsAether.charm_res_web_01), 20),
				MapGen.genMap(new ItemStack(ItemsAether.charm_res_web_02), 5));
				//MapGen.genMap(new ItemStack(ItemsAether.charm_slsh_dmg_01), 20),
				//MapGen.genMap(new ItemStack(ItemsAether.charm_slsh_dmg_02), 5));
