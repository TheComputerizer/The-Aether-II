...
public class BlocksAetherInit
{
	...
	public static void onRegisterBlocks(final RegistryEvent.Register<Block> event) {
		...
		r.register("highlands_ice_crystal", new BlockIceCrystal().setCreativeTab(TAB_NATURAL_BLOCKS));
		...
		r.register("faded_holystone_brick_wall", new BlockCustomWall(holystone.getDefaultState(), 1.5f, 10.0f).setCreativeTab(TAB_DECORATIVE_BLOCKS));
		...
		r.register("outpost_campfire", new BlockOutpostCampfire(Material.ROCK).setCreativeTab(TAB_UTILITY));
		...
		r.register("therawood_log_wall", new BlockSkyrootWall(new BlockAetherLog(AetherWoodType.THERA).getDefaultState(), 2.0f, 10.0f).setCreativeTab(TAB_THERA));
		...
		r.register("therawood_fence", new BlockSkyrootFence().setCreativeTab(TAB_THERA));
		r.register("therawood_fence_gate", new BlockSkyrootFenceGate().setCreativeTab(TAB_THERA));
