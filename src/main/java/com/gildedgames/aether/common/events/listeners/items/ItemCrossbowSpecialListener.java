...
public class ItemCrossbowSpecialListener
{
    ...
    {
        if (event.player.getHeldItem(EnumHand.MAIN_HAND).getItem() instanceof ItemCrossbow || event.player.getHeldItem(EnumHand.OFF_HAND).getItem() instanceof ItemCrossbow)
        {
